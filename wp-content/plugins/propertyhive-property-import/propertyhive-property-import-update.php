...
/*
*  properthive_property_import_update
*
...
class properthive_property_import_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-property-import-c350alqg/update-info.php',
...
if( is_admin() )
{
	new properthive_property_import_update();
}
